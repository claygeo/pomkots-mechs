...
public class Pmv01Entity extends PomkotsVehicleBase {
        ...
        if (!world.isClientSide()) {
            ...
            for (int i = 0; i < 4; i++) {
                for (var v : Utils.circlePosRad9) {
                    Utils.destroyBlock(world, new BlockPos(tgtOffset.getX() + v.getX(), tgtOffset.getY() + v.getY() + i, tgtOffset.getZ() + v.getZ()), false, this);
                }
            }

            for (var v : Utils.circlePosRad7) {
                Utils.destroyBlock(world, new BlockPos(tgtOffset.getX() + v.getX(), tgtOffset.getY() + v.getY() + 4, tgtOffset.getZ() + v.getZ()), false, this);
            }

            for (var v : Utils.circlePosRad5) {
                Utils.destroyBlock(world, new BlockPos(tgtOffset.getX() + v.getX(), tgtOffset.getY() + v.getY() + 5, tgtOffset.getZ() + v.getZ()), false, this);
            }
        }
    }
    ...
    private void fireScop(Level world) {
        if (!world.isClientSide()) {
            ...
            for (var v : Utils.circlePosRad9) {
                Utils.destroyBlock(world, new BlockPos(tgtOffset.getX() + v.getX(), tgtOffset.getY() - 0, tgtOffset.getZ() + v.getZ()), false, this);
            }

            for (var v : Utils.circlePosRad9) {
                Utils.destroyBlock(world, new BlockPos(tgtOffset.getX() + v.getX(), tgtOffset.getY() - 1, tgtOffset.getZ() + v.getZ()), false, this);
            }

            for (var v : Utils.circlePosRad7) {
                Utils.destroyBlock(world, new BlockPos(tgtOffset.getX() + v.getX(), tgtOffset.getY() - 2, tgtOffset.getZ() + v.getZ()), false, this);
            }

            for (var v : Utils.circlePosRad5) {
                Utils.destroyBlock(world, new BlockPos(tgtOffset.getX() + v.getX(), tgtOffset.getY() - 3, tgtOffset.getZ() + v.getZ()), false, this);
            }
        }
    }
